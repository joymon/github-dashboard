...
gh api user/repos --jq '. | map({created_at: .created_at, name: .name, organization: .owner.login,archived: .archived, fork: .fork, forks_count: .forks_count,open_issues_count: .open_issues_count,stars_count: .stargazers_count, watchers_count: .watchers_count,size:.size})' > ./data/repositories.json
