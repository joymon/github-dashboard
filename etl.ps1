...
gh api user/repos --paginate --jq '. | map({created_at: .created_at, name: .name,html_url: .html_url, organization: .owner.login,organization_html_url: .owner.html_url, license: .license.name,is_private: .private, archived: .archived, fork: .fork, forks_count: .forks_count,open_issues_count: .open_issues_count,stars_count: .stargazers_count, watchers_count: .watchers_count,size_kb:.size,has_pages: .has_pages, last_pushed_at: .pushed_at,homepage: .homepage})' > ./data/repositories.json
